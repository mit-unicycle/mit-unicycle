...
<section class="images">
    <div class="image_container" style="background-image: url('/images/Home_page/one_axis_centered.png');"></div>
    <div class="image_container" style="background-image: url('/images/Home_page/two_axis_centered.jpg');"></div>
</section>
